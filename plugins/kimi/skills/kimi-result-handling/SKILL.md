...
- If the helper output contains a working-tree write warning from a review run, repeat it prominently before the findings.
- Use the file paths and line numbers exactly as the helper reports them.
- Preserve evidence boundaries. If Kimi marked something as an inference, uncertainty, or follow-up question, keep that distinction.
